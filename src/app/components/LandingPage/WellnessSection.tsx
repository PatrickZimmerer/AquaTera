          ...
          <div className='z-20 flex h-full max-w-[33.3125rem] flex-col justify-end gap-y-4 pb-16 md:mr-44 md:ml-auto md:justify-start md:gap-y-6 md:pt-36'>
            ...
            <div className='font-dmSans flex flex-col gap-y-6'>
              <p data-aos='fade-left' className='font-dmSans text-[0.9375rem] leading-[140%] md:text-lg'>
                ...
                sanctuary for integrated healing and education. Nestled within ancient bushland, the retreat will
                feature off-grid eco-pods and thoughtfully designed wellness facilities—providing space for guests to
                reconnect with nature and themselves.
              </p>

              <p data-aos='fade-left' className='font-dmSans text-[0.9375rem] leading-[140%] md:text-lg'>
                The retreat will embody Aquatera’s vision of holistic, evidence-aligned wellbeing. Designed to
                complement our medical and research initiatives, it will serve as a space where science, nature, and
                human experience come together.
              </p>
            </div>
          </div>
        </Parallax>
