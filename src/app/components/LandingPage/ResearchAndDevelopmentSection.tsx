      ...
      <div className='side-padding flex h-full min-h-full flex-col justify-between gap-y-24'>
        <Parallax className='z-20' speed={20}>
          <div
            data-aos={'fade-up'}
            data-aos-offset='200'
            className='relative flex max-w-[33.3125rem] flex-col gap-y-4 pt-16 md:mr-auto md:mb-36 md:ml-44 md:justify-start md:gap-y-6 md:pt-24 lg:pt-40'
          >
          ...
          <ul className='max-lg: z-20 flex flex-col gap-y-6 pb-12 max-lg:max-w-[33.3125rem] md:ml-44 md:pb-20 lg:mx-32 lg:flex-row lg:justify-between lg:gap-x-8 lg:pb-32'>
            ...
            <li data-aos='fade-up' data-aos-delay={isMobile ? 0 : 200} className='flex flex-col gap-y-4'>
              ...
              <p className='font-dmSans text-[0.9375rem] leading-[140%]'>
                introduces a dedicated genetics and formulation lab for in-house breeding, compound isolation, and
                testing of novel delivery formats.
              </p>
            </li>
            ...
            <li data-aos='fade-up' data-aos-delay={isMobile ? 0 : 400} className='flex flex-col gap-y-4'>
              ...
              <p className='font-dmSans text-[0.9375rem] leading-[140%]'>
                focuses on clinical trial readiness, integrating GMP-aligned processes, advanced extraction, and
                research partnerships to support regulatory pathways.
              </p>
            </li>
            ...
            <li data-aos='fade-up' data-aos-delay={isMobile ? 0 : 600} className='flex flex-col gap-y-4'>
              ...
              <p className='font-dmSans text-[0.9375rem] leading-[140%]'>
                are underpinned by modular infrastructure and integrated analytics, ensuring traceability, compliance,
                and commercial readiness at every stage.
              </p>
            </li>
          </ul>
        </Parallax>
